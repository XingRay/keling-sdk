...
import com.github.xingray.kelingsdk.createDualAndPollQuery
import com.github.xingray.kelingsdk.createSingleAndPollQuery
...
class VideoEffectApiTest : BaseApiIntegrationTest() {
    ...
    fun queryByExternalId_withCredentials_shouldReturnResponse() = runBlocking {
        assumeEnvReady()
        val response = client.videoEffect.queryByExternalId(credentials, TestFixtures.externalTaskId())
        assertBasicResponse(response)
    }
